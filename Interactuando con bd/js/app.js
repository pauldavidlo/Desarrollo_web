...
class EventsManager {
    constructor() { // #1 al momento de crear un objeto de esta clase, el constructor de inicializa automaticamente y llama la funcion ovtenerData inicial
        this.obtenerDataInicial()
    }


    obtenerDataInicial() { //#2 si nuestra conexion nos resgresa un OK llamamos la funcion poblarCalendario
        ...
        $.ajax({
          ...
          success: (data) =>{
            ...
            if (data.msg=="OK") {
              //alert(data.final)
              this.poblarCalendario(data.evento)
    ...
    poblarCalendario(eventos) { // #4 Esta funcion se encarga de mostrarnos el calendario en el html
